<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>boos/css/bootstrap.css">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Por favor llene los campos para agregar el Proveedor Correspondiente</h3>
 ...
 <?php
    ...
    ?>
                <input type="text" name="Proveedor" placeholder="Escriba el Proveedor" class="form-control">

                <input type="text" name="Pais" placeholder="Escriba el lugar de Origen" class="form-control">
                <input type="text" name="Cantidad" placeholder="Escriba la cantigad que esta Ingresando" class="form-control">
                <input type="text" name="Peso " placeholder="Escriba de cuantos kilos es..." class="form-control">
