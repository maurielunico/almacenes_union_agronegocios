 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block" class="btn btn-outline-success">
        <a href="<?php echo base_url();?>index.php/estudiante/ubicacionlte" class="nav-link">Ubicacion</a>
      </li>
    ...
    <ul>
      <li>
         <a href="<?php echo base_url(); ?>index.php/usuarios/logout">
                <button type="button" class="btn btn-outline-danger"><img width="25" src="<?php echo base_url();?>adminlte/dist/img/cerrar.jpg " ></button>
            </a>
      </li>
    </ul>
