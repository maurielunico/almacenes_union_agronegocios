 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="<?php echo base_url();?>adminlte/dist/img/union.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Mauricio Orellana Hinojosa</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url();?>index.php/estudiante/personal2_listalte" class="nav-link">
         ...
         <!-- <li class="nav-item">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
                <a href="<?php echo base_url();?>index.php/estudiante/fino2_listalte" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Entrada de Producto SUPER PREMIUN</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url();?>index.php/estudiante/dogfit2_listalte" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Entrada de Producto PREMIUN ESPECIAL</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url();?>index.php/estudiante/japi2_listalte" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Entrada de Producto PREMIUN</p>
                </a>
              </li>
              <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/estudiante/salida2_listalte" class="nav-link">
              <i class="nav-icon fas fa-shopping-cart"></i>
              <p>
               Salida de Productos
                <i class="right fas fa-angle-left"></i>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/estudiante/Proveedor2_listalte" class="nav-link">
