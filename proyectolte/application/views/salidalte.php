          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button  type="button" class="btn btn-outline-primary"><img width="55" src="<?php echo base_url();?>adminlte/dist/img/salida2.jpg " ><br>Agregar Nombre del Producto que Saldra</button>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td> <?php echo form_open_multipart('estudiante/modificarsalida'); ?>
